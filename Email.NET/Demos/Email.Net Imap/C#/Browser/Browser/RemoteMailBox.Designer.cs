namespace Browser
{
	partial class RemoteMailBox
	{
		...
		private void InitializeComponent()
		{
			...
			this._client = new Email.Net.Imap.ImapClient(this.components);
			...
			this.tbHostname.Text = "imap.someserver.com";
			// 
			// label3
			// 
			...
			this.tbLogin.Text = "mail@somserver.com";
			// 
			// tbPassword
			// 
