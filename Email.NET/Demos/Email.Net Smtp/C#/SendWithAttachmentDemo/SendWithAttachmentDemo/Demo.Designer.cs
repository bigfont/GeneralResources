namespace SendWithAttachmentDemo
{
	partial class Demo
	{
		...
		private void InitializeComponent()
		{
			...
			this.subjectBox.Text = "Test message with attachment Subject";
			// 
			// label4
			// 
			...
			this.messageBox.Size = new System.Drawing.Size(242, 98);
			this.messageBox.TabIndex = 3;
			this.messageBox.Text = "This demo shows how to send message with attachment.\r\nChoose attachment file in d" +
			...
			// fileBox
			// 
			this.fileBox.Location = new System.Drawing.Point(41, 212);
			this.fileBox.Name = "fileBox";
			this.fileBox.Size = new System.Drawing.Size(207, 20);
			this.fileBox.TabIndex = 4;
			this.fileBox.Enter += new System.EventHandler(this.fileBox_Enter);
			// 
			// label7
			// 
			...
			this.Text = "Email.Net Send a message with attachment demo";
