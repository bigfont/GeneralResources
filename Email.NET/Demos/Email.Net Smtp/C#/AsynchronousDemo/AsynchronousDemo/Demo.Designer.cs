namespace AsynchronousDemo
{
	partial class Demo
	{
		...
		private void InitializeComponent()
		{
			...
			this.statusLabel.Location = new System.Drawing.Point(7, 244);
			...
			this.messageBox.Text = "This demo is shows how to send several messages asynchronously.\r\nInsert your 1st " +
				"message text here and press Complete. After, insert 2nd message text here.";
			// 
			// portNum
			// 
			...
			// sendMessage
			// 
			this.sendMessage.Location = new System.Drawing.Point(44, 191);
			...
			this.Text = "Email.Net Asynchronous send several messages demo";
