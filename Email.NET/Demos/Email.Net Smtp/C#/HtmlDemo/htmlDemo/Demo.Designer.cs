namespace htmlDemo
{
	partial class Demo
	{
		...
		private void InitializeComponent()
		{
			...
			// sendMessage
			// 
			this.sendMessage.Location = new System.Drawing.Point(41, 231);
			...
			this.messageBox.Text = "This demo is shows how to create and send message.\r\nInsert your message text here" +
				".";
			// 
			// portNum
			// 
			...
			// plainBox
			// 
			this.plainBox.Location = new System.Drawing.Point(12, 164);
			this.plainBox.Multiline = true;
			this.plainBox.Name = "plainBox";
			this.plainBox.Size = new System.Drawing.Size(147, 62);
			this.plainBox.TabIndex = 6;
			this.plainBox.Text = "Insert message plain text here.";
			// 
			// label8
			// 
			...
			this.label8.Text = "Message PlainText:";
			// 
			// Demo
			// 
			...
			this.Text = "Email.Net  An HTML message demo";
