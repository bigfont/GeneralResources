namespace SendSeveralDemo
{
	partial class Demo
	{
		...
		private void InitializeComponent()
		{
			...
			this.messageComplete = new System.Windows.Forms.Button();
			...
			// toBox
			// 
			this.toBox.Location = new System.Drawing.Point(64, 50);
			this.toBox.Name = "toBox";
			this.toBox.Size = new System.Drawing.Size(184, 20);
			...
			// fromBox
			// 
			this.fromBox.Location = new System.Drawing.Point(64, 19);
			this.fromBox.Name = "fromBox";
			this.fromBox.Size = new System.Drawing.Size(184, 20);
			...
			this.messageBox.Text = " This document specifies an Internet standards track protocol for the\r\n   Interne" +
				"t community, and requests discussion and suggestions for\r\n   improvements.";
			// 
			// loginBox
			// 
			...
			// sendMessage
			// 
			this.sendMessage.Location = new System.Drawing.Point(44, 231);
			...
			// messageComplete
			// 
			this.messageComplete.Location = new System.Drawing.Point(44, 202);
			this.messageComplete.Name = "messageComplete";
			this.messageComplete.Size = new System.Drawing.Size(75, 23);
			this.messageComplete.TabIndex = 0;
			this.messageComplete.Text = "Complete";
			this.messageComplete.UseVisualStyleBackColor = true;
			this.messageComplete.Click += new System.EventHandler(this.messageComplete_Click);
			// 
			// target
			// 
			...
			this.Controls.Add(this.messageComplete);
			...
			this.Text = "Email.Net Send several messages demo";
		...
		private System.Windows.Forms.Button messageComplete;
