Partial Class RemoteMailBox
	...
	Private Sub InitializeComponent()
		...
		Me._client = New Email.Net.Pop3.Pop3Client(Me.components)
		...
		Me.nPort.TabIndex = 8
		Me.nPort.Value = New Decimal(New Integer() {110, 0, 0, 0})
		' 
		' label2
		' 
        ...
        Me.tbHostname.Text = "pop.someserver.com"
		' 
		' label3
		' 
        ...
        Me.tbLogin.Text = "mail@someserver.com"
		' 
		' tbPassword
		' 
		...
		' _client
		' 
		Me._client.AttachmentDirectory = ""
	...
	Private _client As Email.Net.Pop3.Pop3Client
